...
def get_args_parser():
    ...
    parser.add_argument('--batch_size', default=256, type=int, help='Batch size per GPU (effective batch size is batch_size * accum_iter * # gpus')
    ...
    # Dataset parameters
    parser.add_argument('--output_dir', default='./output_dir/mae-base-200',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir/mae-base-200',
